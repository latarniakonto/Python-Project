...
if __name__ == "__main__":
    ...
    exp2 = Add(Divide(Times(Subtract(Constant(0), Constant(22)),
                    Constant(3)), Constant(11)),
                Constant(17))
    ...
    inst2 = Instruction(
        ...
        While(
            Variable("y"),
            Instruction(Assign(Variable("y"), Add(Variable("y"), Constant(1))), 
            Assign(Variable("x"), Times(Variable("x"), Constant(3))))
            )))
